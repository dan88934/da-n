...
const bio = `<p>
Hey, I'm Dan. I'm a Full Stack Developer and DevOps Engineer with extensive experience in building web applications using languages such as Python, Go, and JavaScript, and deploying them in a Linux environment with tools including NGINX and Docker.
</p><br><p>I started coding when I was in university, where my major was Japanese language. I went on to further develop my skills by creating my own projects and contributing to a large production codebase during my time working for 1Password in a tech support role.</p><br><p> You can find examples of my work in my Upwork portfolio and here on my personal website.</p>`;
const IndexDark = () => {
  return (
    <Layout bg={"blured"}>
      <Head>
