...
</p><br><p>I started coding when I was in university, where my major was Japanese language. I went on to further develop my skills by creating my own projects and contributing to a large production codebase during my time working for 1Password in a tech support role.</p><br><p> You can find examples of my work on my Upwork portfolio and here on my personal website.</p>`;
const IndexDark = () => {
  return (
    <Layout bg={"blured"}>
      <Head>
